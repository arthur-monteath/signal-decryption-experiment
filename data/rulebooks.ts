...
export interface Rulebook {
  ...
  export const rulebookA: Rulebook = {
    playerA: [
      "The number of dots within your partner's marked symbols must equal the number of circular symbols in your grid.",
    ...
    playerB: [
      ...
      "No straight line in your partner's grid may have more than 10 dots."
    ]
  };
